...
describe('test Single and/or Recurring donation ', ()=>{
  ...
  const email = ('st_ecomm_' + todaysDate + '@tellamazingstories.com')
  ...
  beforeEach(() => {
    ...
    it('loads with correct page 1 content', () => {
      ...
      it('adds product to the cart', () => {
        ...
        cy.get('#en__field_supporter_emailAddress').should('have.value', 'st_ecomm@tellamazingstories.com')
    ...
    it('can add and remove items in cart', () => {
        ...
        cy.location('pathname').should('have', '/page/13531/shop/4')
