...
describe('test partial refund for IATS gateway for Single and Recurring transactions', ()=>{
    ...
    const donationSingle = ('en_stripe_sepa_partial_single_donation_' + todaysDate + '@tellamazingstories.com')
    const donationRecur = ('en_istripe_sepa_partial_recur_donation_' + todaysDate + '@tellamazingstories.com')
    ...
    it('can submit single donation', () =>{
        ...
        cy.get('#en__field_transaction_othamt1').type('other 1')
