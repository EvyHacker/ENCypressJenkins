...
describe('test Single and/or Recurring donation ', ()=>{
  ...
  const email = ('single_donation_memoriam_' + todaysDate + '@tellamazingstories.com')
  ...
  beforeEach(() => {
    ...
    it('has correct data', () => {
        ...
        .should('have.value', 'singledonationmemoriam@tellamazingstories.com')
        ...
        cy.get('#en__field_transaction_infemail').should('have.value', "st_informemail@tellamazingstories.com")
    ...
    it('it submits single donation', () =>{
      ...
      cy.get(':nth-child(28)').contains("st_informemail@tellamazingstories.com")
