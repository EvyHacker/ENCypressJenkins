...
describe('test Single and/or Recurring donation ', ()=>{
    ...
    it('loads with correct page 1 content', () => {
        ...
        cy.get('#en__field_supporter_emailAddress').should('have.value', 'st_premiumgifts@tellamazingstories.com')
    ...
    function addShippingDetails(){
        ...
        cy.get('#en__field_transaction_shipemail').should('have.value', 'st_premiumdonationfs@tellamazingstories.com')
