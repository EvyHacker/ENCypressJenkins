...
describe('test Single and/or Recurring donation ', ()=>{
    ...
    function AddSingleTicket(){
        ...
        cy.get('#en__field_event_ticketType_0_tickets_0_registrants_0_emailAddress').type('st_eventsdallas@tellamazingstories.com')
    ...
    function AddGroupTicket(){
        ...
        cy.get('#en__field_event_ticketType_1_tickets_0_registrants_0_emailAddress').type('st_eventsdallas@tellamazingstories.com')
        ...
        cy.get('#en__field_event_ticketType_1_tickets_0_registrants_1_emailAddress').type('st_eventsdallas@tellamazingstories.com')
        ...
        cy.get('#en__field_event_ticketType_1_tickets_0_registrants_2_emailAddress').type('st_eventsdallas@tellamazingstories.com')
    ...
    function AddMultiGroupTicket(){
        ...
        cy.get('#en__field_event_ticketType_1_tickets_1_registrants_0_emailAddress').type('st_eventsdallas@tellamazingstories.com')
        ...
        cy.get('#en__field_event_ticketType_1_tickets_1_registrants_1_emailAddress').type('st_eventsdallas@tellamazingstories.com')
        ...
        cy.get('#en__field_event_ticketType_1_tickets_1_registrants_2_emailAddress').type('st_eventsdallas@tellamazingstories.com')
