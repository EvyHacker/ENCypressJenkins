...
describe('test Single donation IATS', ()=>{
  ...
  const emailRecur = ('st_recurdonation_dallas_' + todaysDate + '@tellamazingstories.com')
  const emailSingle = ('st_singledonation_dallas_' + todaysDate + '@tellamazingstories.com')
  ...
  beforeEach(() => {
    ...
    it('has correct data', () => {
        ...
        .should('have.value', 'st_donationtwogateways@tellamazingstories.com')
