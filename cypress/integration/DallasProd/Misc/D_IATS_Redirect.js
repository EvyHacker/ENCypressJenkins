...
describe('test redirect links when conditions are met', ()=>{
    ...
    it('redirects to http://dev.politicalnetworks.com/page/2767/hub/1?mode=DEMO when donationAmount = 50', () =>{
        ...
        cy.get('#en__field_transaction_othamt2').type('12')
        cy.get('button').click()
        cy.url().should('eq', 'http://dev.politicalnetworks.com/page/2767/hub/1?mode=DEMO')
