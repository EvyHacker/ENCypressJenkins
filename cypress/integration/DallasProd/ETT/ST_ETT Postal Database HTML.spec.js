...
describe('test Single and/or Recurring donation ', ()=>{
    ...
    const email = ('ett_postal_target_' + todaysDate + '@tellamazingstories.com')
    beforeEach(() => {
    ...
    it('sends an email to target', () =>{
        ...
        cy.location('pathname').should('have', '/page/15183/action/2')

        validateETTMessage()

        cy.location('pathname').should('have', '/page/15183/action/3')
