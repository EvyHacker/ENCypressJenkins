...
describe('test Single and/or Recurring donation ', ()=>{
  ...
  const email = ('st_petition_toronto_' + todaysDate + '@tellamazingstories.com')
  ...
  it('submits successfully petition', () => {
    ...
    cy.get('#en__field_supporter_lastName').should('have.value', 'Petition')
    cy.get('#en__field_supporter_city').should('have.value', 'Tribeca')
    cy.get('#en__field_supporter_emailAddress').should('have.value', 'st_petitiontoronto@tellamazingstories.com')
