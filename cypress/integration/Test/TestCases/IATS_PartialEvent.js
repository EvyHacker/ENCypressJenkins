describe('test partial refund for Iats gateway for event tickets', ()=>{
    ...
    const ticket = ('en_iats_partial_events_' + todaysDate + '@tellamazingstories.com')
    const ticketDiscount = ('en_iats_partial_event_discount_' + todaysDate + '@tellamazingstories.com')
